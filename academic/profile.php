                ...
                <div class="tile-body">
                    <form class="app_frm" action="academic/core/update_profile" method="POST" autocomplete="off">
                        ...
                        <div class="mb-2">
                            ...
                            <input value="<?php echo $fname; ?>" required name="fname"
                                onkeypress="return lettersOnly(event)" class="form-control" type="text"
                                placeholder="Enter first name">
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Last Name</label>
                            <input value="<?php echo $lname; ?>" required name="lname"
                                onkeypress="return lettersOnly(event)" class="form-control" type="text"
                                placeholder="Enter last name">
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Email Address</label>
                            <input value="<?php echo $email; ?>" required name="email" class="form-control" type="email"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="gender" required>
                                ...
                                <option <?php if ($gender == "Male") { print ' selected '; } ?> value="Male">Male
                                </option>
