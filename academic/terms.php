...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item active" href="academic/terms"><i
            ...
            <li class="treeview"><a class="app-menu__item" href="javascript:void(0);" data-toggle="treeview"><i
                ...
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="academic/promote_students"><i class="icon bi bi-circle-fill"></i>
                            Promote Students</a></li>
                </ul>
            </li>
...
?>
                                    <textarea style="display:none;"
                                        id="term_<?php echo $row[0]; ?>"><?php echo $row[1]; ?></textarea>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a onclick="set_term('<?php echo $row[0]; ?>', '<?php echo $row[2]; ?>');"
                                                class="btn btn-primary btn-sm" href="javascript:void(0);"
                                                data-bs-toggle="modal" data-bs-target="#editModal">Edit</a>
                                            <a onclick="del('academic/core/drop_term?id=<?php echo $row[0]; ?>', 'Delete Academic Term?');"
