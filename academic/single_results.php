            ...
            <div class="col-md-12 ">
                <div class="tile">
                    <div class="tile-body">
                        ...
                        <form enctype="multipart/form-data" action="academic/core/update_results" class="app_frm row"
...
?>
                            ...
                            <div class="mb-3 col-md-2">
                                ...
                                <input value="<?php echo $score; ?>" name="<?php echo $row[0];?>" class="form-control"
                                    required type="number" placeholder="Enter score">
                            </div>
...
?>
                            ...
                            <div class="">
                                ...
                                <?php if ($tscore > 0) {
?><a onclick="del('academic/core/drop_results?src=single_results&std=<?php echo $std; ?>&class=<?php echo $std_data[0][6]; ?>&term=<?php echo $term; ?>', 'Delete Results?');"
                                    href="javascript:void(0);" class="btn btn-danger">Delete</a><?php
}
?>
                            </div>
                        </form>
