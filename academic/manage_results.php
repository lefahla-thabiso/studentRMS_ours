        ...
        <ul class="app-menu">
            ...
            <li class="treeview is-expanded"><a class="app-menu__item" href="javascript:void(0);"
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item active" href="academic/manage_results"><i
                                class="icon bi bi-circle-fill"></i> Manage Results</a></li>
                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="table-responsive">
                            ...
                            <form enctype="multipart/form-data" action="academic/core/start_manage" class="app_frm"
