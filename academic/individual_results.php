            ...
            <li class="treeview is-expanded"><a class="app-menu__item" href="javascript:void(0);"
                ...
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="academic/manage_results"><i class="icon bi bi-circle-fill"></i>
                            Manage Results</a></li>
                    <li><a class="treeview-item  active" href="academic/individual_results"><i
            ...
            <div class="col-md-4 center_form">
                <div class="tile">
                    <div class="tile-body">
                        <div class="table-responsive">
                            ...
                            <form enctype="multipart/form-data" action="academic/core/start_edit" class="app_frm"
               ...
               foreach ($result as $row) { ?>
                                        <option value="<?php echo $row[0]; ?>">
                                            <?php echo $row[1] . " " . $row[2] . " " . $row[3] . " (" . $row[0] . ")"; ?>
                                        </option>
                                        <?php }
               ...
               $stmt = $conn->prepare(
                   "SELECT * FROM tbl_terms WHERE status = '1'"
               );
               $stmt->execute();
               $result = $stmt->fetchAll();
