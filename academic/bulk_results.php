...
?>
                                        ...
                                        <td align="center" width="190">
                                            ...
                                            <a href="academic/save_pdf?std=<?php echo $row2[0]; ?>&term=<?php echo $term;?>"
                                                class="btn btn-primary btn-sm" href="javascript:void(0);">Report</a>
                                            <a onclick="del('academic/core/drop_results?src=bulk_results&std=<?php echo $row2[0]; ?>&class=<?php echo $class; ?>&term=<?php echo $term; ?>', 'Delete Results?');"
