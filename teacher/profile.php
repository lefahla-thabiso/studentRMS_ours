...
<body class="app sidebar-mini">
        ...
        <ul class="app-nav">
            ...
            <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown"
                ...
                <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    <li><a class="dropdown-item" href="teacher/profile"><i class="bi bi-person me-2 fs-5"></i>
                            Profile</a></li>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li><a class="app-menu__item" href="teacher/index.php"><i
                        class="app-menu__icon feather icon-monitor"></i><span
                        class="app-menu__label">Dashboard</span></a></li>
            <li><a class="app-menu__item" href="teacher/terms"><i class="app-menu__icon feather icon-folder"></i><span
                        class="app-menu__label">Academic Terms</span></a></li>
            <li><a class="app-menu__item" href="teacher/combinations"><i
            ...
            <li class="treeview"><a class="app-menu__item" href="javascript:void(0);" data-toggle="treeview"><i
                        class="app-menu__icon feather icon-users"></i><span class="app-menu__label">Students</span><i
                        class="treeview-indicator bi bi-chevron-right"></i></a>
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="teacher/list_students"><i class="icon bi bi-circle-fill"></i>
                            List Students</a></li>
                    <li><a class="treeview-item" href="teacher/export_students"><i class="icon bi bi-circle-fill"></i>
                            Export Students</a></li>
                </ul>
            </li>
            <li class="treeview"><a class="app-menu__item" href="javascript:void(0);" data-toggle="treeview"><i
                ...
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="teacher/import_results"><i class="icon bi bi-circle-fill"></i>
                            Import Results</a></li>
                    <li><a class="treeview-item" href="teacher/manage_results"><i class="icon bi bi-circle-fill"></i>
                            View Results</a></li>
                </ul>
            </li>
            <li><a class="app-menu__item" href="teacher/grading-system"><i
            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <div class="mb-2">
                        ...
                        <input value="<?php echo $fname; ?>" required disabled name="fname" class="form-control"
                            type="text" placeholder="Enter first name">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Last Name</label>
                        <input value="<?php echo $lname; ?>" required disabled name="lname" class="form-control"
                            type="text" placeholder="Enter last name">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Email Address</label>
                        <input value="<?php echo $email; ?>" required disabled name="email" class="form-control"
                    ...
                    <div class="mb-2">
                        ...
                        <select disabled class="form-control" name="gender" required>
                            ...
                            <option <?php if ($gender == "Female") { print ' selected '; } ?> value="Female">Female
                            </option>
                        </select>
                    </div>
                ...
                <div class="tile-body">
                    ...
                    <form class="app_frm" action="teacher/core/update_password" method="POST" autocomplete="off">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="password" class="form-control" id="_npass" name="npassword"
                        ...
                        <button type="submit" id="sub_btnp" name="submit" value="1" class="btn btn-primary">Change
                            Password</button>
