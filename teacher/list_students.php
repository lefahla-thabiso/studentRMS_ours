        ...
        <ul class="app-menu">
            ...
            <li class="treeview is-expanded"><a class="app-menu__item" href="javascript:void(0);"
                ...
                <ul class="treeview-menu">
                    <li><a class="treeview-item active" href="teacher/list_students"><i
                                class="icon bi bi-circle-fill"></i> List Students</a></li>
...
?>
                                ...
                                <button type="submit" name="submit" value="1" class="btn btn-primary app_btn">List
                                    Students</button>
                            </form>
                        </div>
                    </div>
