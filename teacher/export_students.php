                    ...
                    <div class="tile-body">
                        <div class="table-responsive">
                            ...
                            <form class="app_frm" method="POST" autocomplete="OFF"
                                action="teacher/core/export_students">
                                ...
                                <button type="submit" name="submit" value="1" class="btn btn-primary app_btn">Export
                                    Students</button>
                            ...
                            <div class="alert alert-info mt-3" role="alert">
                                <b>CSV File generated, click <a download href="<?php echo $files; ?>"
                                        class="alert-link">HERE</a> to download.</b>
                            </div>
