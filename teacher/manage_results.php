...
<body class="app sidebar-mini">
            ...
            <li class="treeview is-expanded"><a class="app-menu__item" href="javascript:void(0);"
                ...
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="teacher/import_results"><i class="icon bi bi-circle-fill"></i>
                            Import Results</a></li>
                    <li><a class="treeview-item active" href="teacher/manage_results"><i
                                class="icon bi bi-circle-fill"></i> View Results</a></li>
                </ul>
            </li>
                    ...
                    <div class="tile-body">
                        <div class="table-responsive">
                            ...
                            <form class="app_frm" enctype="multipart/form-data" method="POST" autocomplete="OFF"
                                action="teacher/core/view_results">
    ...
    echo "Connection failed: " . $e->getMessage();
                                ...
                                <div class="mb-2">
                                    ...
                                    <select onchange="fetch_subjects(this.value);" class="form-control select2"
                                        name="class" required style="width: 100%;">
                                ...
                                <button type="submit" name="submit" value="1" class="btn btn-primary app_btn">View
                                    Results</button>
                            </form>
                        </div>
                    </div>
