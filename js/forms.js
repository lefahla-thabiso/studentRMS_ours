...
function set_term(id, status) {
  document.getElementById("term").value = document.getElementById(
    "term_" + id
  ).value;
...
function set_combination(id) {
  var loader =
    "<div class='d-flex justify-content-center'><div class='spinner-border' style='height:16px; width:16px; margin-top:2px;'  role='status'><span class='sr-only'></span></div>&nbsp;Fetching information, please wait..</div>";
  document.getElementById("comb_feedback").innerHTML =
...
function set_grade(id) {
  document.getElementById("grade").value = document.getElementById(
    "grade_" + id
  ).value;
  document.getElementById("min").value = document.getElementById(
    "min_" + id
  ).value;
  document.getElementById("max").value = document.getElementById(
    "max_" + id
  ).value;
  document.getElementById("remark").value = document.getElementById(
    "remark_" + id
  ).value;
  document.getElementById("id").value = id;
}
...
function set_announcement(id) {
  var loader =
    "<div class='d-flex justify-content-center'><div class='spinner-border' style='height:16px; width:16px; margin-top:2px;'  role='status'><span class='sr-only'></span></div>&nbsp;Fetching information, please wait..</div>";
  document.getElementById("ajax_callback").innerHTML =
    '<div class="alert alert-dismissible alert-info"><strong>' +
    loader +
    "</strong> </div>";
...
$("#sub_btnp").on("click", function () {
  ...
  if (!checkval) {
    Swal.fire({
      title:
        "Password must contain At least one uppercase letter, one lowercase letter, one digit, one special symbol",
      icon: "error",
      showDenyButton: false,
      confirmButtonText: "Okay",
    });
...
function set_division(id) {
  document.getElementById("division").value = document.getElementById(
    "division_" + id
  ).value;
  document.getElementById("min").value = document.getElementById(
    "min_" + id
  ...
  document.getElementById("min2").value = document.getElementById(
    "min2_" + id
  ).value;
  document.getElementById("max2").value = document.getElementById(
    "max2_" + id
  ).value;
  document.getElementById("points").value = document.getElementById(
    "points_" + id
  ).value;
  document.getElementById("id").value = id;
}
...
function set_student(id) {
  ...
  document.getElementById("mname").value = document.getElementById(
    "mname_" + id
  ).value;
  document.getElementById("lname").value = document.getElementById(
    "lname_" + id
  ...
  document.getElementById("class").value = document.getElementById(
    "class_" + id
  ).value;
  document.getElementById("email").value = document.getElementById(
    "email_" + id
  ).value;
  document.getElementById("photo").value = document.getElementById(
    "img_" + id
  ).value;
  document.getElementById("id").value = id;
