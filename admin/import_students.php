...
<body class="app sidebar-mini">
        ...
        <ul class="app-menu">
            ...
            <li class="treeview is-expanded"><a class="app-menu__item" href="javascript:void(0);"
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item active" href="admin/import_students"><i
                                class="icon bi bi-circle-fill"></i> Import Students</a></li>
    ...
    <main class="app-content">
        ...
        <div class="alert alert-info">
            <a download href="templates/import_students.xlsx" class="alert-link"> Download excel template from here</a>
        </div>
        <div class="row">
                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="table-responsive">
                            ...
                            <form enctype="multipart/form-data" action="admin/core/import_students" class="app_frm"
                                ...
                                <div class="mb-2">
                                    ...
                                    <select id="class_selected" class="form-control select2" name="selected_class"
