...
?>
                                        ...
                                        <td align="center" width="130">
                                            ...
                                            <textarea style="display:none;"
                                                id="mname_<?php echo $row[0]; ?>"><?php echo $row[2]; ?></textarea>
                                            <textarea style="display:none;"
                                                id="lname_<?php echo $row[0]; ?>"><?php echo $row[3]; ?></textarea>
                                            <textarea style="display:none;"
                                                id="gender_<?php echo $row[0]; ?>"><?php echo $row[4]; ?></textarea>

                                            <textarea style="display:none;"
                                                id="email_<?php echo $row[0]; ?>"><?php echo $row[5]; ?></textarea>
                                            <textarea style="display:none;"
                                                id="class_<?php echo $row[0]; ?>"><?php echo $row[6]; ?></textarea>
                                            <textarea style="display:none;"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" action="admin/core/update_student" class="app_frm"
                            method="POST" autocomplete="OFF">
                            <div class="mb-2">
                                <label class="form-label">First Name</label>
                                <input id="fname" name="fname" required class="form-control"
                                    onkeypress="return lettersOnly(event)" type="text" placeholder="Enter first name">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Middle Name</label>
                                <input id="mname" name="mname" required class="form-control"
                                    onkeypress="return lettersOnly(event)" type="text" placeholder="Enter middle name">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Last Name</label>
                                <input id="lname" name="lname" required class="form-control"
                                    onkeypress="return lettersOnly(event)" type="text" placeholder="Enter last name">
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <select id="class" class="form-control select2" name="class" required
                                    style="width: 100%;">
...
?>
                            ...
                            <div class="mb-2">
                                ...
                                <input id="email" name="email" required class="form-control" type="text"
