...
<head>
    ...
    <script src="summernote/jquery-3.4.1.slim.min.js"
...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li><a class="app-menu__item" href="admin/index.php"><i class="app-menu__icon feather icon-monitor"></i><span
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addModalLabel">Blocking Student</h5>
                    </div>
                    <div class="modal-body">
                        <form class="app_frm" method="POST" autocomplete="OFF" action="admin/core/block_student">
                            ...
                            <div class="mb-2">
                                ...
                                <select class="form-control select2" name="studentClass" required>
                                    <option value="" selected disabled>Select One</option>
                                    <?php

										
										foreach ($studenClass as $studentDetails) {
											$student_id = $studentDetails[0];
											$student_name  = $studentDetails[1] ;
												echo "<option value='$student_id'>$student_name</option>";
												// $studenClass = $student_id;
												var_dump($student_id);
											}
										// }
