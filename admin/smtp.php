    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="admin/report"><i
                        ...
                        Tool</span></a></li>
            <li><a class="app-menu__item active" href="admin/smtp"><i class="app-menu__icon feather icon-mail"></i><span
...
?>
                        <div class="form-group mb-2">
                            ...
                            <input required type="text" name="mail_server" value="<?php echo $row[1]; ?>"
                                class="form-control" placeholder="Enter SMTP Server">
                        </div>

                        <div class="form-group mb-2">
                            <label class="control-label">SMTP Username</label>
                            <input required type="text" name="mail_username" value="<?php echo $row[2]; ?>"
                                class="form-control" placeholder="Enter SMTP Username">
                        </div>

                        <div class="form-group mb-2">
                            <label class="control-label">SMTP Password</label>
                            <input required type="text" name="mail_password" value="<?php echo $row[3]; ?>"
                                class="form-control" placeholder="Enter SMTP Password">
                        </div>

                        <div class="form-group mb-2">
                            <label class="control-label">SMTP Port</label>
                            <input required type="text" name="mail_port" value="<?php echo $row[4]; ?>"
                        ...
                        <div class="box-footer">
                            <button type="submit" name="submit" value="1"
                                class="btn btn-primary app_btn">Update</button>
                        </div>
                    </form>
                    <?php
}
