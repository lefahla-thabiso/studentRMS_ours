...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item active" href="admin/academic"><i
                        class="app-menu__icon feather icon-user"></i><span class="app-menu__label">Academic
                        Account</span></a></li>
...
?>
                    <div class="mb-2">
                        <label class="form-label">First Name</label>
                        <input value="<?php echo $row[1]; ?>" disabled name="fname" class="form-control" type="text"
                            placeholder="Enter first name">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Last Name</label>
                        <input value="<?php echo $row[2]; ?>" disabled required name="lname" class="form-control"
                            type="text" placeholder="Enter last name">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Email Address</label>
                        <input value="<?php echo $row[4]; ?>" disabled required name="email" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <select disabled class="form-control" name="gender" required>
                            ...
                            <option <?php if ($row[3] == "Female") { print ' selected '; } ?> value="Female">Female
                            </option>
                        </select>
                    </div>

                    <div class="box-footer">
                        <a onclick="del('admin/core/drop_user?id=<?php echo $row[0]; ?>', 'Delete Academic?');"
