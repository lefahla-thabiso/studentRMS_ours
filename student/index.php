...
?>
	...
	<body class="app sidebar-mini">
		...
		<aside class="app-sidebar">
			...
			<ul class="app-menu">
				<li><a class="app-menu__item active" href="student"><i class="app-menu__icon feather icon-monitor"></i><span
				...
				<li><a class="app-menu__item" href="student/grading-system"><i
                        ...
                        System</span></a></li>
				<!-- <li><a class="app-menu__item" href="student/division-system"><i -->class="app-menu__icon feather icon-layers"></i><span class="app-menu__label">Division
                        System</span></a>
				</li>
			</ul>
		</aside>
...
?>!
    ...
    if (count($result) < 1) { ?>
							<div class="alert alert-dismissible alert-info"> <strong>There is no any announcements at the moment</strong> </div>
							<?php }
