...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li><a class="app-menu__item active" href="student/index.php"><i
            ...
            <li><a class="app-menu__item" href="student/subjects"><i
                        ...
                        Subjects</span></a></li>
            <!-- <li><a class="app-menu__item" href="student/results"><i
            ...
            <li><a class="app-menu__item" href="student/grading-system"><i
                        ...
                        System</span></a></li>
            <!-- <li><a class="app-menu__item" href="student/division-system"><i -->class="app-menu__icon feather
            icon-layers"></i><span class="app-menu__label">Division
                System</span></a>
            </li>
        </ul>
    </aside>
...
?>!
    ...
    $stmt = $conn->prepare(
        "SELECT * FROM tbl_announcements WHERE level = '1' OR level = '2' ORDER BY id DESC"
    );
    $stmt->execute();
    $result = $stmt->fetchAll();

    if (count($result) < 1) { ?>
                    <div class="alert alert-dismissible alert-info"> <strong>There is no any announcements at the
                            moment</strong> </div>
                    <?php }
