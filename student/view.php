				...
				<div class="row col-md-4">
					<div>
						<a href="javascript:void(0);" data-toggle="modal" class="img-rounded">
							<?php
							if ($gender == "Male") {
								echo '<img style="border-radius: 50%;" src="../images/students/Male.png" class="rounded-circle">';
							} else {
								echo '<img "border-radius: 50%;" src="../images/students/Female.png" class="rounded-circle">';
							}
							?>
						</a>
					</div>
