...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li>
                <a class="app-menu__item" href="student"> <i class="app-menu__icon feather icon-monitor"></i> <span
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <?php
                                                        ...
                                                        foreach ($_terms as $key => $_term) {
                                                            if ($t == "1") {
                                                                ?>
                                            <div class="mt-3 tab-pane fade active show"
                                                id="term_<?php echo $_term[0]; ?>" role="tabpanel">
                                                ...
                                                <a target="_blank"
                                                    href="student/save_pdf?term=<?php echo $_term[0]; ?>&currentClass=<?=urlencode($class); ?>"
                                                    class="btn btn-primary btn-sm">DOWNLOAD</a>
                                            </div>
                                            <?php
                                                             } else {
