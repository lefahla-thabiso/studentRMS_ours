...
<body class="app sidebar-mini">
        ...
        <ul class="app-nav">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    <li>
                        <a class="dropdown-item" href="student/settings"> <i class="bi bi-person me-2 fs-5"></i> Change
                            Password </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="logout"> <i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout
                        </a>
                    </li>
                </ul>
            </li>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li>
                <a class="app-menu__item" href="student/index.php"> <i class="app-menu__icon feather icon-monitor"></i>
                    <span class="app-menu__label">Dashboard</span> </a>
            </li>
            <li>
                <a class="app-menu__item" href="student/view"> <i class="app-menu__icon feather icon-user"></i> <span
                        class="app-menu__label">My Profile</span> </a>
            </li>
            <li>
                <a class="app-menu__item" href="student/subjects"> <i class="app-menu__icon feather icon-book-open"></i>
                    <span class="app-menu__label">My Subjects</span> </a>
            </li>
            <!-- <li>
            ...
            <li class="treeview"><a class="app-menu__item" href="javascript:void(0);" data-toggle="treeview"><i
                ...
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="student/results"><i class="icon bi bi-circle-fill"></i>My
                            <?php echo date("Y");?> Results</a></li>
                    <li><a class="treeview-item" href="student/previous_results"><i class="icon bi bi-circle-fill"></i>
                            Previous Years Results</a></li>
                </ul>
            </li>
            <li>
                <a class="app-menu__item" href="student/grading-system"> <i
                ...
                <div class="tile">
                    ...
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="autoForm">
                        <div class="mb-2">
                            ...
                            <select id="autoSelect" class="form-control select2" name="yearofstudy" required
                                ...
                                <option value="<?php echo $id[0];?>"
                                    <?php  if($selectedValue == $row[0]) echo "selected";?>>
                                ...
                                <div class="bs-component">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="mt-3 tab-pane fade active show" id="term_<?php echo $_term[0]; ?>"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" width="100">
                                                            <?php if($score != 0) echo $score; ?></td>
                                                        <td align="center" width="100">
                                                            <?php if($score != 0) echo $grd; ?></td>
                                                        <td align="center" width="200">
                                                            <?php if($score != 0) echo $rm; ?></td>
                                                    </tr <?php
                                                                                }
                                                                                $n++;
                                                                            }
                                            ...
                                            <a target="_blank"
                                                href="student/save_pdf?term=<?php echo $_term[0]; ?>&currentClass=<?=urlencode($displayMessage); ?>"
                                            ...
                                            <table class="table table-bordered table-striped table-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" width="100">
                                                            <?php if($score != 0) echo $score;?></td>
                                                        <td align="center" width="100"><?php if($score) echo $grd; ?>
                                                        </td>
                                                        <td align="center" width="200"><?php if($score) echo $rm; ?>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                                                }
